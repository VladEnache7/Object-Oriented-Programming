...
ServiceUser::ServiceUser(RepoShelterDogs &repoShelter, RepoAdoptedDogs *repoAdopted, std::string shelterFile_, std::string adoptedFile_)
        : repoShelter{repoShelter}, shelterFile{std::move(shelterFile_)}, adoptedFile{std::move(adoptedFile_)} {
